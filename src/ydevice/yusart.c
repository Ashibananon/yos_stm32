...
#define DEFAULT_USART_GPIO_BANK_TX			GPIOA
#define DEFAULT_USART_GPIO_BANK_RX			GPIOA
#define DEFAULT_USART_GPIO_TX				GPIO9
#define DEFAULT_USART_GPIO_RX				GPIO10
...
static void yusart_init(uint32_t baudrate, uint8_t stop_bits)
{
	...
	gpio_mode_setup(DEFAULT_USART_GPIO_BANK_RX, GPIO_MODE_AF,
				GPIO_PUPD_NONE, DEFAULT_USART_GPIO_RX);
	gpio_set_af(DEFAULT_USART_GPIO_BANK_TX, GPIO_AF7, DEFAULT_USART_GPIO_TX);
	gpio_set_af(DEFAULT_USART_GPIO_BANK_RX, GPIO_AF7, DEFAULT_USART_GPIO_RX);
